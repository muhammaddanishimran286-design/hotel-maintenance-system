...
['TC-018','Continue as Guest from login page','Guest Access','Unauthenticated browser session',['Open the login page','Select Continue as Guest','Observe the guest report page'],['Login page is displayed','Guest option is visible and clickable','Guest Maintenance Report page opens without authentication']],
['TC-019','Submit guest maintenance report with image','Guest Report','Problem title, location, urgency, description and optional image',['Open the guest report page','Enter issue details and attach a valid image','Submit the guest report'],['Guest form is displayed','Valid guest data and image are accepted','Report is saved as Pending and success feedback appears']],
['TC-020','Guest cannot view protected maintenance pages','Guest Security','Unauthenticated guest session',['Submit or open guest report page','Navigate directly to /dashboard','Navigate directly to /maintenance'],['Guest report page remains public','Dashboard redirects to Login','Maintenance list redirects to Login']],
['TC-021','Automated regression suite','Technical Validation','PHPUnit feature and unit tests',['Run the project test suite','Review all test groups','Confirm assertion summary'],['Test runner starts without configuration error','Authentication, profile and application tests complete','26 tests and 65 assertions pass with zero failures']]
];
